...
Le schéma ci-dessous présente un plan orthonormé en 3D, avec comme axes X, Y et Z. Lorsque l'on inscrit un pixel sur une image, par exemple "m", nous avons pris la valeur du point M sur ses axes x et  car le capteur n'a pas de notion de profondeur, qui est la dimension manquante, la Z.
